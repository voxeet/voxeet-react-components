...
export const strings = new LocalizedStrings({
  en: {
    ...
    error: 'Error',
    errorPermissionDeniedMicrophone: 'An error occured when joining the conference. Please make sure to allow access to your microphone.',
    ...
    descPeerConnectionFailedError:
      'Your computer cannot connect to the communications platform, check your network setup, and try again. ' +
      'If the problem persists, contact your app provider for help.',
    descPeerConnectionDisconnectedError:
      'There was a temporary network glitch that may have affected your call, if the problem persists please disconnect and rejoin.',
    descPeerNotFoundError: 'Connection to server could not be established. Please check your network connection.',
    descRemoteDescriptionError:
      'The system was unable to set up your call due to a call negotiation failure. ' +
    ...
    record: 'Record',
    shareAlreadyStarted: 'Someone is already sharing. Please stop it before start a new one.',
    share: 'Share',
    ...
    listener: 'Listener',
    left: 'Left',
    noAudioDevice: 'No audio device detected. Please make sure to plug at least one microphone to access this conference.',
    filepresentation: 'Share a File',
    prev: 'Previous',
    next: 'Next',
    errorFilePresentation: 'An error occured during the file presentation. Please check your file.',
  ...
  fr: {
    ...
    error: 'Erreur',
    errorPermissionDeniedMicrophone: "Une erreur est survenue lors de la connexion à la conference. Veuillez vérifier l'accès à votre microphone.",
    errorPermissionDeniedMicrophoneCamera:
    ...
    record: 'Enregistrer',
    share: 'Partager',
    shareAlreadyStarted: "Un partage est déja en cours, veuillez l'arrêter avant d'en commencer un nouveau.",
    ...
    listener: 'Auditeur',
    left: 'Déconnecté',
    noAudioDevice: "Pas de microphone détécté. Veuillez vérifier d'avoir au moins un microphone branché pour accéder à la conférence.",
    filepresentation: 'Partager un fichier',
    prev: 'Précédent',
    next: 'Suivant',
    errorFilePresentation: 'Une erreur est survenue durant le partage de fichier. Veuillez vérifier votre fichier.',
    ...
    dolbyVoiceNotSupported: 'Impossible d’utiliser Dolby Voice',
  },
});
